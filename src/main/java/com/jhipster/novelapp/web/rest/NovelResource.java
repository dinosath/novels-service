...
public class NovelResource {
    ...
    public ResponseEntity<NovelDTO> createNovel(@Valid @RequestBody NovelDTO novelDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/novels/" + novelDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, novelDTO.getId().toString()))
            .body(novelDTO);
    }
    ...
    public ResponseEntity<NovelDTO> updateNovel(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, novelDTO.getId().toString()))
            .body(novelDTO);
    }
    ...
    public ResponseEntity<NovelDTO> partialUpdateNovel(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, novelDTO.getId().toString())
        );
    }
