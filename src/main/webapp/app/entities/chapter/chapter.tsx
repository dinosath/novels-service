  ...
  return (
    <div>
      <h2 id="chapter-heading" data-cy="ChapterHeading">
        <Translate contentKey="novelsApp.chapter.home.title">Chapters</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="novelsApp.chapter.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/chapter/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="novelsApp.chapter.home.createLabel">Create new Chapter</Translate>
          </Link>
        </div>
      </h2>
        ...
        {chapterList && chapterList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="novelsApp.chapter.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th>
                  <Translate contentKey="novelsApp.chapter.novel">Novel</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {chapterList.map((chapter, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{chapter.novel ? <Link to={`/novel/${chapter.novel.id}`}>{chapter.novel.title}</Link> : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="novelsApp.chapter.home.notFound">No Chapters found</Translate>
            </div>
          )
        )}
      </div>
