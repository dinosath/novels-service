...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './novel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOVEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NOVEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NOVEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_NOVEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_NOVEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NOVEL actions', async () => {
      const arg = 42666;
