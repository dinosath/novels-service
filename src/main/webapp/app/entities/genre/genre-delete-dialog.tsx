...
export const GenreDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/genre' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="novelsApp.genre.delete.question">
        <Translate contentKey="novelsApp.genre.delete.question" interpolate={{ id: genreEntity.id }}>
